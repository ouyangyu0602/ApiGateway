 ...
 */
public abstract class DefaultPluginClient<T extends Serializable> implements PluginClient<T> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultPluginClient.class);
